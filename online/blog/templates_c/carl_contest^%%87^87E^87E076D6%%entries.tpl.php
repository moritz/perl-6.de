<?php /* Smarty version 2.6.14, created on 2007-03-29 18:41:51
         compiled from file:/var/www//blog/templates/carl_contest/entries.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'serendipity_hookPlugin', 'file:/var/www//blog/templates/carl_contest/entries.tpl', 2, false),array('function', 'serendipity_printTrackbacks', 'file:/var/www//blog/templates/carl_contest/entries.tpl', 116, false),array('function', 'serendipity_printComments', 'file:/var/www//blog/templates/carl_contest/entries.tpl', 133, false),array('modifier', 'formatTime', 'file:/var/www//blog/templates/carl_contest/entries.tpl', 9, false),array('modifier', 'makeFilename', 'file:/var/www//blog/templates/carl_contest/entries.tpl', 12, false),array('modifier', 'escape', 'file:/var/www//blog/templates/carl_contest/entries.tpl', 19, false),array('modifier', 'emptyPrefix', 'file:/var/www//blog/templates/carl_contest/entries.tpl', 19, false),array('modifier', 'default', 'file:/var/www//blog/templates/carl_contest/entries.tpl', 30, false),array('modifier', 'truncate', 'file:/var/www//blog/templates/carl_contest/entries.tpl', 30, false),array('modifier', 'sprintf', 'file:/var/www//blog/templates/carl_contest/entries.tpl', 65, false),)), $this); ?>
<!-- ENTRIES START -->
...
"><img class="serendipity_entryIcon" title="<?php echo smarty_modifier_escape($this->_tpl_vars['entry_category']['category_name']);  echo serendipity_emptyPrefix($this->_tpl_vars['entry_category']['category_description']); ?>
...
" /></a>
            ...
            <?php endif; ?>
			<?php if ($this->_tpl_vars['is_single_entry']): ?>
			<?php echo @POSTED_BY; ?>
...
</a><?php if (! ($this->_foreach['categories']['iteration'] == $this->_foreach['categories']['total'])): ?>, <?php endif;  endforeach; endif; unset($_from); ?>
                <?php endif; ?>
			<br />
			<?php else: ?><a href="<?php echo $this->_tpl_vars['entry']['link']; ?>
"><?php echo ((is_array($_tmp=smarty_modifier_default(@$this->_tpl_vars['entry']['title'], @$this->_tpl_vars['entry']['body']))) ? $this->_run_mod_handler('truncate', true, $_tmp, 40, " ...") : smarty_modifier_truncate($_tmp, 40, " ...")); ?>
</a> <?php echo @POSTED_BY; ?>
 <a href="<?php echo $this->_tpl_vars['entry']['link_author']; ?>
"><?php echo $this->_tpl_vars['entry']['author']; ?>
</a>
                <?php if ($this->_tpl_vars['entry']['categories']): ?>
...
"><?php echo smarty_modifier_escape($this->_tpl_vars['entry_category']['category_name']); ?>
                ...
                <?php endif; ?> <?php if ($this->_tpl_vars['dategroup']['is_sticky']):  echo serendipity_smarty_formatTime($this->_tpl_vars['entry']['timestamp'], 'DATE_FORMAT_ENTRY');  else: ?> <?php echo serendipity_smarty_formatTime($this->_tpl_vars['entry']['timestamp'], '%H:%M');  endif; ?><br />
		<?php endif; ?>
			<?php if ($this->_tpl_vars['entry']['is_entry_owner'] && ! $this->_tpl_vars['is_preview']): ?>
                        <br /><a href="<?php echo $this->_tpl_vars['entry']['link_edit']; ?>
"><?php echo @EDIT_ENTRY; ?>
</a>
                <?php endif; ?>
                <?php if ($this->_tpl_vars['entry']['has_comments']): ?>
                    <?php if ($this->_tpl_vars['use_popups']): ?>
                        <br /><a href="<?php echo $this->_tpl_vars['entry']['link_popup_comments']; ?>
...
#comments"><?php echo $this->_tpl_vars['entry']['label_comments']; ?>
 (<?php echo $this->_tpl_vars['entry']['comments']; ?>
                ...
                <?php if ($this->_tpl_vars['entry']['has_trackbacks']): ?>
                    <?php if ($this->_tpl_vars['use_popups']): ?>
                        <br /><a href="<?php echo $this->_tpl_vars['entry']['link_popup_trackbacks']; ?>
...
"><?php echo ((is_array($_tmp=smarty_modifier_default(@$this->_tpl_vars['entry']['title'], @$this->_tpl_vars['entry']['body']))) ? $this->_run_mod_handler('truncate', true, $_tmp, 200, " ...") : smarty_modifier_truncate($_tmp, 200, " ...")); ?>
</a></h4>
...
"><?php echo @TRACKBACK_SPECIFIC; ?>
 ...
 | <a rel="nofollow" href="<?php echo $this->_tpl_vars['entry']['link_viewmode_threaded']; ?>
...
<br /><?php echo @THIS_COMMENT_NEEDS_REVIEW; ?>
	...
	<h3 class="serendipity_date"><?php echo @ADMIN_FRONTPAGE; ?>
</h3>
		<div class="serendipity_overview_noentries"><?php echo @NO_ENTRIES_TO_PRINT; ?>
</div>
    <?php endif; ?>
...
">&laquo; <?php echo @PREVIOUS_PAGE; ?>
		...
		<?php else: ?>
		<span class="grey">&laquo; <?php echo @PREVIOUS_PAGE; ?>
</span>&#160;&#160;
		<?php endif; ?>
	<?php else: ?>
	<?php endif; ?>
...
"><?php echo @NEXT_PAGE; ?>
 &raquo;</a>
		<?php else: ?>
		&#160;&#160;<span class="grey"><?php echo @NEXT_PAGE; ?>
 &raquo;</span>
		<?php endif; ?>
	<?php else: ?>
	<?php endif; ?>

	<br /><?php if (! $this->_tpl_vars['startpage']): ?><a href="<?php echo $this->_tpl_vars['serendipityBaseURL']; ?>
"><?php echo @ADMIN_FRONTPAGE; ?>
</a><?php endif;  if (! $this->_tpl_vars['footer_info']): ?> - <a href="#topofpage"><?php echo @TOP_LEVEL; ?>
</a><?php endif; ?>
