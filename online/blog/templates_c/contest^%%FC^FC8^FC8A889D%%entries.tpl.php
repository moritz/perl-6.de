<?php /* Smarty version 2.6.14, created on 2007-03-30 11:32:41
         compiled from file:/var/www//blog/templates/contest/entries.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'serendipity_hookPlugin', 'file:/var/www//blog/templates/contest/entries.tpl', 2, false),array('function', 'serendipity_printTrackbacks', 'file:/var/www//blog/templates/contest/entries.tpl', 123, false),array('function', 'serendipity_printComments', 'file:/var/www//blog/templates/contest/entries.tpl', 139, false),array('modifier', 'formatTime', 'file:/var/www//blog/templates/contest/entries.tpl', 12, false),array('modifier', 'escape', 'file:/var/www//blog/templates/contest/entries.tpl', 19, false),array('modifier', 'makeFilename', 'file:/var/www//blog/templates/contest/entries.tpl', 53, false),array('modifier', 'emptyPrefix', 'file:/var/www//blog/templates/contest/entries.tpl', 58, false),array('modifier', 'sprintf', 'file:/var/www//blog/templates/contest/entries.tpl', 73, false),array('modifier', 'default', 'file:/var/www//blog/templates/contest/entries.tpl', 90, false),)), $this); ?>
<!-- ENTRIES START -->
...
?>
    ...
    <div class="serendipity_Entry_Date">
        ...
        <div class="serendipity_title_footer">
            <span class="serendipity_footer_postedby"><?php echo @POSTED_BY; ?>
...
"><?php echo $this->_tpl_vars['entry']['author']; ?>
            ...
            <span class="serendipity_footer_categories"><?php echo @IN; ?>
...
</a><?php if (! ($this->_foreach['categories']['iteration'] == $this->_foreach['categories']['total'])): ?>, <?php endif;  endforeach; endif; unset($_from); ?></span>
            <?php endif; ?>
...
"><?php if ($this->_tpl_vars['dategroup']['is_sticky']):  echo serendipity_smarty_formatTime($this->_tpl_vars['entry']['timestamp'], 'DATE_FORMAT_ENTRY'); ?>
 <?php endif;  echo serendipity_smarty_formatTime($this->_tpl_vars['entry']['timestamp'], '%H:%M'); ?>
</a>
            </span>
...
" /></a>
            ...
            <div class="serendipity_extended_link"><a href="<?php echo $this->_tpl_vars['entry']['link']; ?>
#extended"><?php echo sprintf(@VIEW_EXTENDED_ENTRY, $this->_tpl_vars['entry']['title']); ?>
            ...
            <div class="serendipity_entryFooter">
                <?php if ($this->_tpl_vars['entry']['is_entry_owner'] && ! $this->_tpl_vars['is_preview']): ?>
                    <span class="serendipity_footer_owner"><a href="<?php echo $this->_tpl_vars['entry']['link_edit']; ?>
"><?php echo @EDIT_ENTRY; ?>
</a></span>
                <?php endif; ?>
...
" />
        ...
        -->
        <div class="serendipity_footer_plugin"><?php echo $this->_tpl_vars['entry']['plugin_display_dat']; ?>
</div>
...
"><?php echo @TRACKBACK_SPECIFIC; ?>
        ...
        <?php if ($this->_tpl_vars['is_single_entry'] && ! $this->_tpl_vars['is_preview']): ?>
            <div class="serendipity_comments serendipity_section_comments">
                ...
                <div class="serendipity_center serendipity_comments_displaymode"><?php echo @DISPLAY_COMMENTS_AS; ?>
...
">&laquo; <?php echo @PREVIOUS_PAGE; ?>
    ...
    <?php if ($this->_tpl_vars['footer_info']): ?>
        <span class="serendipity_footer_pagination">(<?php echo $this->_tpl_vars['footer_info']; ?>
)</span>
    <?php endif; ?>
