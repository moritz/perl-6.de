<?php /* Smarty version 2.6.14, created on 2007-03-29 18:41:51
         compiled from file:/var/www//blog/templates/carl_contest/plugin_calendar.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'serendipity_getFile', 'file:/var/www//blog/templates/carl_contest/plugin_calendar.tpl', 5, false),array('function', 'cycle', 'file:/var/www//blog/templates/carl_contest/plugin_calendar.tpl', 27, false),array('modifier', 'formatTime', 'file:/var/www//blog/templates/carl_contest/plugin_calendar.tpl', 10, false),array('modifier', 'default', 'file:/var/www//blog/templates/carl_contest/plugin_calendar.tpl', 29, false),)), $this); ?>
...
" src="<?php echo serendipity_smarty_getFile(array('file' => "img/back.gif"), $this);?>
...
" src="<?php echo serendipity_smarty_getFile(array('file' => "img/forward.gif"), $this);?>
" width="16" height="12" style="border: 0px" /></a>
<?php endif; ?>
        </td>
    </tr>
...
"><?php endif;  echo smarty_modifier_default(@$this->_tpl_vars['day']['name'], "&#160;");  if (isset ( $this->_tpl_vars['day']['properties']['Active'] ) && $this->_tpl_vars['day']['properties']['Active']): ?></a><?php endif; ?></td>
        <?php endforeach; endif; unset($_from); ?>
        </tr>
    <?php endforeach; endif; unset($_from); ?>
</table>